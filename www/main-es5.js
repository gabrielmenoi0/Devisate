...
var map = {
	...
	"./contabilidade/contabilidade.module": [
		"./src/app/contabilidade/contabilidade.module.ts",
		"contabilidade-contabilidade-module"
	],
	"./ds/ds.module": [
		"./src/app/ds/ds.module.ts",
		"ds-ds-module"
	],
	"./enfermagem/enfermagem.module": [
		"./src/app/enfermagem/enfermagem.module.ts",
		"enfermagem-enfermagem-module"
	],
	"./infonet/infonet.module": [
		"./src/app/infonet/infonet.module.ts",
		"infonet-infonet-module"
	],
	"./informatica/informatica.module": [
		"./src/app/informatica/informatica.module.ts",
		"informatica-informatica-module"
	],
	"./logistica/logistica.module": [
		"./src/app/logistica/logistica.module.ts",
		"logistica-logistica-module"
	],
	"./sj/sj.module": [
		"./src/app/sj/sj.module.ts",
		"sj-sj-module"
	],
	"./st/st.module": [
		"./src/app/st/st.module.ts",
		"st-st-module"
	],
	"./tecadm/tecadm.module": [
		"./src/app/tecadm/tecadm.module.ts",
		"tecadm-tecadm-module"
	],
	"./tecds/tecds.module": [
		"./src/app/tecds/tecds.module.ts",
		"tecds-tecds-module"
	]
};
...
module.exports = __webpack_require__(/*! C:\ionic\devisate\src\main.ts */"./src/main.ts");
